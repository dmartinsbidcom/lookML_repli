# The name of this view in Looker is "Ds Checkoutbidcom Mlproducts Promotions"
view: ds_checkoutbidcom_mlproducts_promotions {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_checkoutbidcom.MLProducts_promotions` ;;
