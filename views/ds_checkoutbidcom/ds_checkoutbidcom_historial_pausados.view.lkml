# The name of this view in Looker is "Ds Checkoutbidcom Historial Pausados"
view: ds_checkoutbidcom_historial_pausados {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_checkoutbidcom.HistorialPausados` ;;
