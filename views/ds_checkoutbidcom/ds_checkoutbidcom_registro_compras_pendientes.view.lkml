# The name of this view in Looker is "Ds Checkoutbidcom Registro Compras Pendientes"
view: ds_checkoutbidcom_registro_compras_pendientes {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_checkoutbidcom.registro_compras_pendientes` ;;
