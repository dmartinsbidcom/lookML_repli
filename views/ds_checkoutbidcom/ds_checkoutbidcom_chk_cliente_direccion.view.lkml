# The name of this view in Looker is "Ds Checkoutbidcom Chk Cliente Direccion"
view: ds_checkoutbidcom_chk_cliente_direccion {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_checkoutbidcom.CHK_Cliente_Direccion` ;;
