# The name of this view in Looker is "Ds Checkoutbidcom Cupon Descuento Copy"
view: ds_checkoutbidcom_cupon_descuento_copy {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_checkoutbidcom.CuponDescuento_copy` ;;
