# The name of this view in Looker is "Ds Checkoutbidcom Codigos Postales Amba"
view: ds_checkoutbidcom_codigos_postales_amba {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_checkoutbidcom.codigos_postales_amba` ;;
