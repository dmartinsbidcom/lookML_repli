# The name of this view in Looker is "Ds Checkoutbidcom Chk Datos Fiscales"
view: ds_checkoutbidcom_chk_datos_fiscales {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_checkoutbidcom.CHK_DatosFiscales` ;;
