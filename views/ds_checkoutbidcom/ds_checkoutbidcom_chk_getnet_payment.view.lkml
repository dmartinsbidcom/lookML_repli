# The name of this view in Looker is "Ds Checkoutbidcom Chk Getnet Payment"
view: ds_checkoutbidcom_chk_getnet_payment {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_checkoutbidcom.CHK_getnet_payment` ;;
