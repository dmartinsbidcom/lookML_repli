# The name of this view in Looker is "Pricing Ranking 26 X"
view: pricing_ranking_26_x {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gestion_comercial.pricing_ranking_26_x` ;;
  ...
  dimension: cantidad_total_26 {
    type: number
    sql: ${TABLE}.cantidad_total_26 ;;
  }
  ...
  dimension: monto_total_26 {
    type: number
    sql: ${TABLE}.monto_total_26 ;;
  }
