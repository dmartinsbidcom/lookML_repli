# The name of this view in Looker is "Pricing Ranking 31 X"
view: pricing_ranking_31_x {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gestion_comercial.pricing_ranking_31_x` ;;
  ...
  dimension: cantidad_total_31 {
    type: number
    sql: ${TABLE}.cantidad_total_31 ;;
  }
  ...
  dimension: monto_total_31 {
    type: number
    sql: ${TABLE}.monto_total_31 ;;
  }
