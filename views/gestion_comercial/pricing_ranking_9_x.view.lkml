# The name of this view in Looker is "Pricing Ranking 9 X"
view: pricing_ranking_9_x {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gestion_comercial.pricing_ranking_9_x` ;;
  ...
  dimension: cantidad_total_9 {
    type: number
    sql: ${TABLE}.cantidad_total_9 ;;
  }
  ...
  dimension: monto_total_9 {
    type: number
    sql: ${TABLE}.monto_total_9 ;;
  }
