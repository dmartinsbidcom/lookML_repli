# The name of this view in Looker is "Comisiones Participaciones 4"
view: comisiones_participaciones_4 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gestion_comercial.comisiones_participaciones_4` ;;
