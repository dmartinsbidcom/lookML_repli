# The name of this view in Looker is "Nuevo Precio Float"
view: nuevo_precio_float {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gestion_comercial.nuevo_precio_float` ;;
  ...
  dimension: nuevo_precio_float {
    type: number
    sql: ${TABLE}.nuevo_precio_float ;;
  }
