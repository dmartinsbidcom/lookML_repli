# The name of this view in Looker is "Pricing Ranking Evento X"
view: pricing_ranking_evento_x {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gestion_comercial.pricing_ranking_evento_x` ;;
  ...
  dimension: cantidad_total_evento {
    type: number
    sql: ${TABLE}.cantidad_total_evento ;;
  }
  ...
  dimension: monto_total_evento {
    type: number
    sql: ${TABLE}.monto_total_evento ;;
  }
