# The name of this view in Looker is "Pricing Ranking 4 X"
view: pricing_ranking_4_x {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gestion_comercial.pricing_ranking_4_x` ;;
  ...
  dimension: cantidad_total_4 {
    type: number
    sql: ${TABLE}.cantidad_total_4 ;;
  }
  ...
  dimension: monto_total_4 {
    type: number
    sql: ${TABLE}.monto_total_4 ;;
  }
