# The name of this view in Looker is "Tmp Raw Stream Datadog Logs"
view: tmp_raw__stream_datadog_logs {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `airbyte_internal.TMP_raw__stream_datadog_logs` ;;
