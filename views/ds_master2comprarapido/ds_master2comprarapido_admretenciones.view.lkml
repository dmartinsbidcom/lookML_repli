# The name of this view in Looker is "Ds Master2comprarapido Admretenciones"
view: ds_master2comprarapido_admretenciones {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2comprarapido.admretenciones` ;;
