# The name of this view in Looker is "Ds Master2comprarapido Admctaparametrizadatipos"
view: ds_master2comprarapido_admctaparametrizadatipos {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2comprarapido.admctaparametrizadatipos` ;;
