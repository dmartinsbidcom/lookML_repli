# The name of this view in Looker is "Ds Master2comprarapido Admcomprobantes"
view: ds_master2comprarapido_admcomprobantes {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2comprarapido.admcomprobantes` ;;
