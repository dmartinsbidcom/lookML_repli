# The name of this view in Looker is "Checkoutbidcom Testcheckoutbidcom Log Mercado Pago"
view: checkoutbidcom_testcheckoutbidcom_log_mercado_pago {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `checkoutbidcom_testcheckoutbidcom.LogMercadoPago` ;;
