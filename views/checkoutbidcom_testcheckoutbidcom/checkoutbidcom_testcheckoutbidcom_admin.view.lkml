# The name of this view in Looker is "Checkoutbidcom Testcheckoutbidcom Admin"
view: checkoutbidcom_testcheckoutbidcom_admin {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `checkoutbidcom_testcheckoutbidcom.Admin` ;;
