# The name of this view in Looker is "Checkoutbidcom Testcheckoutbidcom Respuesta"
view: checkoutbidcom_testcheckoutbidcom_respuesta {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `checkoutbidcom_testcheckoutbidcom.Respuesta` ;;
