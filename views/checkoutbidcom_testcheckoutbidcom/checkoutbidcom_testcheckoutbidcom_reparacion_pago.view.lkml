# The name of this view in Looker is "Checkoutbidcom Testcheckoutbidcom Reparacion Pago"
view: checkoutbidcom_testcheckoutbidcom_reparacion_pago {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `checkoutbidcom_testcheckoutbidcom.reparacion_pago` ;;
