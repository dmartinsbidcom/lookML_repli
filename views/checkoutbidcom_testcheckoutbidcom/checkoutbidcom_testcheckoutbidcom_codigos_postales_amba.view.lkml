# The name of this view in Looker is "Checkoutbidcom Testcheckoutbidcom Codigos Postales Amba"
view: checkoutbidcom_testcheckoutbidcom_codigos_postales_amba {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `checkoutbidcom_testcheckoutbidcom.codigos_postales_amba` ;;
