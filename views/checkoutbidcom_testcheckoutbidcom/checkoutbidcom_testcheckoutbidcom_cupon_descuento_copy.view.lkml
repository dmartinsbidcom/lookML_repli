# The name of this view in Looker is "Checkoutbidcom Testcheckoutbidcom Cupon Descuento Copy"
view: checkoutbidcom_testcheckoutbidcom_cupon_descuento_copy {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `checkoutbidcom_testcheckoutbidcom.CuponDescuento_copy` ;;
