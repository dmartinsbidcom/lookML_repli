# The name of this view in Looker is "Ds Master2orbit Percepcionesiibbparametros"
view: ds_master2orbit_percepcionesiibbparametros {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2orbit.percepcionesiibbparametros` ;;
  ...
  dimension: graba_en_orbit {
    type: number
    sql: ${TABLE}.GrabaEnOrbit ;;
  }

  dimension: graba_fc_aen_orbit {
    type: number
    sql: ${TABLE}.GrabaFcAEnOrbit ;;
  }
  ...
  dimension: monto_total_maximo_sin_dni {
    type: number
    sql: ${TABLE}.MontoTotalMaximoSinDNI ;;
  }
