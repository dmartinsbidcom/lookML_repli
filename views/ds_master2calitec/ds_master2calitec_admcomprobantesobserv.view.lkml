# The name of this view in Looker is "Ds Master2calitec Admcomprobantesobserv"
view: ds_master2calitec_admcomprobantesobserv {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2calitec.admcomprobantesobserv` ;;
