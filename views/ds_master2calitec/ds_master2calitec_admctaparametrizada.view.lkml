# The name of this view in Looker is "Ds Master2calitec Admctaparametrizada"
view: ds_master2calitec_admctaparametrizada {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2calitec.admctaparametrizada` ;;
