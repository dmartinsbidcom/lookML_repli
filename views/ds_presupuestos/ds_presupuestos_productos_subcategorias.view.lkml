# The name of this view in Looker is "Ds Presupuestos Productos Subcategorias"
view: ds_presupuestos_productos_subcategorias {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_presupuestos.productos_subcategorias` ;;
