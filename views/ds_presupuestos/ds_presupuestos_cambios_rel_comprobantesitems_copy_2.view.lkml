# The name of this view in Looker is "Ds Presupuestos Cambios Rel Comprobantesitems Copy 2"
view: ds_presupuestos_cambios_rel_comprobantesitems_copy_2 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_presupuestos.cambios_rel_comprobantesitems_copy_2` ;;
