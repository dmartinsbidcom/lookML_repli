# The name of this view in Looker is "Ds Presupuestos Empresas Presupuestos"
view: ds_presupuestos_empresas_presupuestos {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_presupuestos.empresas_presupuestos` ;;
