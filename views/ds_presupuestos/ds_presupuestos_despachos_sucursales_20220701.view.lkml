# The name of this view in Looker is "Ds Presupuestos Despachos Sucursales 20220701"
view: ds_presupuestos_despachos_sucursales_20220701 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_presupuestos.despachos_sucursales_20220701` ;;
