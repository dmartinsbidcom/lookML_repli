# The name of this view in Looker is "Ds Presupuestos Productos"
view: ds_presupuestos_productos {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_presupuestos.productos` ;;
  ...
  dimension: bulto_individual_producto {
    type: number
    sql: ${TABLE}.BultoIndividualProducto ;;
  }
  ...
  dimension_group: fecha_actualizacion_producto {
    type: time
    timeframes: [raw, time, date, week, month, quarter, year]
    sql: ${TABLE}.fechaActualizacionProducto ;;
  }
