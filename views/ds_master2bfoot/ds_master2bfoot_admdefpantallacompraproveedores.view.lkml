# The name of this view in Looker is "Ds Master2bfoot Admdefpantallacompraproveedores"
view: ds_master2bfoot_admdefpantallacompraproveedores {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2bfoot.admdefpantallacompraproveedores` ;;
