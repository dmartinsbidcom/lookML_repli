# The name of this view in Looker is "Mlproducts Checkout Copy"
view: mlproducts_checkout_copy {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `gestion_ofertas_uruguay.MLProducts_checkout_copy` ;;
