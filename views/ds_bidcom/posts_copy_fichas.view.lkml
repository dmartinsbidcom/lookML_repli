# The name of this view in Looker is "Posts Copy Fichas"
view: posts_copy_fichas {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_bidcom.posts_copy_fichas` ;;
  ...
  dimension: volumetrico {
    type: number
    sql: ${TABLE}.volumetrico ;;
  }
  measure: count {
    type: count
