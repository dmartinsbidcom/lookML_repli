...
view: posts {
  ...
  sql_table_name: `ds_bidcom.posts` ;;
  ...
  dimension: bolsa_regalo {
    type: string
    sql: ${TABLE}.bolsa_regalo ;;
  }
  ...
  dimension: cuotas_payway {
    type: number
    sql: ${TABLE}.cuotas_payway ;;
  }
  ...
  dimension: precio_18_cuotas {
    type: number
    sql: ${TABLE}.precio_18_cuotas ;;
  }
  ...
  dimension: ranking_custom_1 {
    type: number
    sql: ${TABLE}.ranking_custom_1 ;;
  }

  dimension: ranking_custom_2 {
    type: number
    sql: ${TABLE}.ranking_custom_2 ;;
  }

  dimension: ranking_custom_3 {
    type: number
    sql: ${TABLE}.ranking_custom_3 ;;
  }

  dimension: ranking_custom_4 {
    type: number
    sql: ${TABLE}.ranking_custom_4 ;;
  }
