# The name of this view in Looker is "Catalogo Category Preg Frecuente"
view: catalogo_category_preg_frecuente {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_panel.catalogo_category_preg_frecuente` ;;
