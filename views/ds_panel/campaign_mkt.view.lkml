# The name of this view in Looker is "Campaign Mkt"
view: campaign_mkt {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_panel.campaign_mkt` ;;
  ...
  dimension: action_values_omni_purchase {
    type: number
    sql: ${TABLE}.action_values_omni_purchase ;;
  }
