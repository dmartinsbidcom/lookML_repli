# The name of this view in Looker is "Ds Master2bemotec Admpantallasdecarga"
view: ds_master2bemotec_admpantallasdecarga {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2bemotec.admpantallasdecarga` ;;
