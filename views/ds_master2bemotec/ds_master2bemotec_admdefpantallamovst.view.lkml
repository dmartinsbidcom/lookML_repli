# The name of this view in Looker is "Ds Master2bemotec Admdefpantallamovst"
view: ds_master2bemotec_admdefpantallamovst {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2bemotec.admdefpantallamovst` ;;
