# The name of this view in Looker is "Ds Master2bidcombo Despachos Medios"
view: ds_master2bidcombo_despachos_medios {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2bidcombo.despachos_medios` ;;
