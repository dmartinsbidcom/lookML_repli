# The name of this view in Looker is "Ds Master2bidcombo Productos Categorias"
view: ds_master2bidcombo_productos_categorias {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2bidcombo.productos_categorias` ;;
