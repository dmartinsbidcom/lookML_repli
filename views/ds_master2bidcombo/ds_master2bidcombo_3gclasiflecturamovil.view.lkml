# The name of this view in Looker is "Ds Master2bidcombo 3gclasiflecturamovil"
view: ds_master2bidcombo_3gclasiflecturamovil {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2bidcombo.3gclasiflecturamovil` ;;
