# The name of this view in Looker is "Ds Master2contable Paises"
view: ds_master2contable_paises {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2contable.paises` ;;
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # This dimension will be called "Codigo Pais" in Explore.
