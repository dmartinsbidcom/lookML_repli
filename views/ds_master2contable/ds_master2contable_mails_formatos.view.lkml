# The name of this view in Looker is "Ds Master2contable Mails Formatos"
view: ds_master2contable_mails_formatos {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2contable.mails_formatos` ;;
