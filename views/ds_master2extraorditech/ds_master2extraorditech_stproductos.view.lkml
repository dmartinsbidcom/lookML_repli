# The name of this view in Looker is "Ds Master2extraorditech Stproductos"
view: ds_master2extraorditech_stproductos {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2extraorditech.stproductos` ;;
