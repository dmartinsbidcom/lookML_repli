# The name of this view in Looker is "Ds Master2extraorditech Admtbbancos"
view: ds_master2extraorditech_admtbbancos {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2extraorditech.admtbbancos` ;;
