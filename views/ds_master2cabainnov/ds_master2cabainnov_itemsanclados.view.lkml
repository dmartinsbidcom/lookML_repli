# The name of this view in Looker is "Ds Master2cabainnov Itemsanclados"
view: ds_master2cabainnov_itemsanclados {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2cabainnov.itemsanclados` ;;
