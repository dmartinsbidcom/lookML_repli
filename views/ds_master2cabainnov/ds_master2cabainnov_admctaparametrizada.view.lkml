# The name of this view in Looker is "Ds Master2cabainnov Admctaparametrizada"
view: ds_master2cabainnov_admctaparametrizada {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2cabainnov.admctaparametrizada` ;;
