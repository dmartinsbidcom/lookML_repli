# The name of this view in Looker is "Migrafamilias"
view: migrafamilias {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2operativo.migrafamilias` ;;
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # This dimension will be called "Categoria Principal Name" in Explore.
