# The name of this view in Looker is "Ds Master2operativo Boreparacion"
view: ds_master2operativo_boreparacion {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2operativo.boreparacion` ;;
  ...
  dimension: iddespachomedio {
    type: number
    sql: ${TABLE}.iddespachomedio ;;
  }

  dimension: idgpsolicitud {
    type: number
  ...
  dimension: productoclienteboreparacion {
    type: number
    sql: ${TABLE}.productoclienteboreparacion ;;
  }
