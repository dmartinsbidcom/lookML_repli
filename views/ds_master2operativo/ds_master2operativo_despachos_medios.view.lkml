# The name of this view in Looker is "Ds Master2operativo Despachos Medios"
view: ds_master2operativo_despachos_medios {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2operativo.despachos_medios` ;;
