# The name of this view in Looker is "Ds Master2operativo Productos Subcategorias"
view: ds_master2operativo_productos_subcategorias {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ds_master2operativo.productos_subcategorias` ;;
